          ...
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="sidebar-scrollbar">
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                ...
                <li  class="active" >
                    <a class="sidenav-item-link" href="index.html">
                    <span class="nav-text">Home Protofile</span>
                    
                    </a>
                </li>
                
                <li  class="active" >
                    <a class="sidenav-item-link" href="{{route('admin.AddBrandPhoto')}}">
                    <span class="nav-text">Home brand</span>
                    
                    </a>
                </li>
                <li  class="active" >
                    <a class="sidenav-item-link" href="{{route('admin.AddNewCar')}}">
                    <span class="nav-text">Home NewCar</span>
                    
                    </a>
                </li>
                <li  class="active" >
                    <a class="sidenav-item-link" href="{{route('admin.ads')}}">
                    <span class="nav-text">Home ADS</span>
                    
                    </a>
                </li>
                <li  class="active" >
                    <a class="sidenav-item-link" href="{{route('admin.reports')}}">
                    <span class="nav-text">Home report</span>
                    
                    </a>
                </li>

                <li  class="active" >
                    <a class="sidenav-item-link" href="{{route('admin.AddOldCar')}}">
                    <span class="nav-text">Home Old car</span>
                    
                    </a>
                </li>
                <li  class="active" >
                    <a class="sidenav-item-link" href="{{route('admin.accounts')}}">
                    <span class="nav-text">Home accounts</span>
                    
                    </a>
                </li>
                <li  class="active" >
                    <a class="sidenav-item-link" href="{{route('admin.UserProfile')}}">
                    <span class="nav-text">Home UserProfile</span>
