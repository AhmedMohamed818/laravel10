...
<body class="animsition" style="text-align: center;">
		...
		<div class="gallery-sidebar t-center p-l-60 p-r-60 p-b-40">
			...
			<div class="wrap-gallery-sidebar flex-w">
				...
				<a class="item-gallery-sidebar wrap-pic-w" href="images/O1CN012bmtpB1IVKGi7x1mi_!!6000000000898-0-m_tb_svideo_preimg.jpg" data-lightbox="gallery-footer">
					<img class="im" src="images/O1CN012bmtpB1IVKGi7x1mi_!!6000000000898-0-m_tb_svideo_preimg.jpg" alt="GALLERY">
				</a>

				<a class="item-gallery-sidebar wrap-pic-w" href="images/H6fd4dfdce23542328ffc2cea9429d321L.jpg" data-lightbox="gallery-footer">
					<img class="im" src="images/H6fd4dfdce23542328ffc2cea9429d321L.jpg" alt="GALLERY">
				</a>
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="wrap-inputname size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="name" placeholder="Brands">
								</div>
							</div>
							...
							<div class="col-md-4">
								...
								<div class="wrap-inputphone size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="phone" placeholder="Model">
								</div>
							</div>
							...
							<div class="col-md-4">
								...
								<div class="wrap-inputemail size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull txt10 p-l-20" type="text" name="email" placeholder="Km">
								</div>
							</div>
                            ...
                            <div class="col-md-4">
								...
								<div class="wrap-inputdate pos-relative txt10 size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class=" bo-rad-10 sizefull txt10 p-l-20" type="text" name="date">
    ...
    color: black;
    border-radius: 50px; height: 40px;" onclick="window.location.href='#';">Change</button>
...
<button style="font-family: Arial, Helvetica, sans-serif;
    ...
    color: black;
    border-radius: 50px; height: 40px;" onclick="window.location.href='changed.html';">Changed</button>
				</div>
			</div>
