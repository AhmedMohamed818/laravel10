          ...
          <label for="{{'s'.$i}}" id="{{'slide'.$i}}">
            <div class="card">
              ...
              <div class="infos">
                ...
                <button onclick="window.location.href='{{ url('/detail ads')}}/<?php echo $r->user_name;?>';" style="background-color: green; width: 50px; border-radius: 50px;" type="submit">View</button>
